...
public class AdapterMenProducts extends RecyclerView.Adapter<AdapterMenProducts.HolderMenProduct> {

    private Context context;
    public ArrayList<ModelProduct> productList;

    public AdapterMenProducts(Context context, ArrayList<ModelProduct> productList) {
    ...
    @NonNull
    @Override
    public HolderMenProduct onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Inflate layout
        View view = LayoutInflater.from(context).inflate(R.layout.row_product_buyer,parent,false);

        return new HolderMenProduct(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HolderMenProduct holder, int position) {
        //get data
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, BuyerOrderMenProducts.class);
    ...
    class HolderMenProduct extends RecyclerView.ViewHolder{

        /*holds views of recyclerview*/
        private ImageView productIcon;
        private TextView productBrand,actualPrice,securityPrice,productAddress;
        public HolderMenProduct(@NonNull View itemView) {
            super(itemView);
