...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderMenProductSeller> {
    ...
    @NonNull
    @Override
    public HolderMenProductSeller onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Inflate layout
        View view = LayoutInflater.from(context).inflate(R.layout.row_product_seller,parent,false);

        return new HolderMenProductSeller(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HolderMenProductSeller holder, int position) {
        //get data
    ...
    class HolderMenProductSeller extends RecyclerView.ViewHolder{

        /*holds views of recyclerview*/
        private ImageView productIcon;
        private TextView productBrand,actualPrice,securityPrice,productAddress;
        public HolderMenProductSeller(@NonNull View itemView) {
            super(itemView);
