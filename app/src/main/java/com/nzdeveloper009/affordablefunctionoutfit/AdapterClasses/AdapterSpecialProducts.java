...
import com.nzdeveloper009.affordablefunctionoutfit.Buyer.RentProducts.Shops.BuyerOrderMenProducts;
...
public class AdapterSpecialProducts extends RecyclerView.Adapter<AdapterSpecialProducts.HolderSpecialProduct> {

    private Context context;
    public ArrayList<ModelProduct> productList;

    public AdapterSpecialProducts(Context context, ArrayList<ModelProduct> productList) {
    ...
    @NonNull
    @Override
    public HolderSpecialProduct onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Inflate layout
        View view = LayoutInflater.from(context).inflate(R.layout.row_product_buyer,parent,false);

        return new HolderSpecialProduct(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HolderSpecialProduct holder, int position) {
        //get data
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, BuyerOrderSpecialProducts.class);
    ...
    class HolderSpecialProduct extends RecyclerView.ViewHolder{
        /*holds views of recyclerview*/
        private ImageView productIcon;
        private TextView productBrand,actualPrice,securityPrice,productAddress;
        public HolderSpecialProduct(@NonNull View itemView) {
            super(itemView);
