...
public class OrderListMenProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_list_men_products);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Credentials").child("SELLER").child(uid).child("Orders").child("Men Products");
                                    ...
                                    .addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            if (snapshot.exists()) {
                                                ...
                                                //setup adapter
                                                adapterOrderBuyer = new AdapterOrderBuyer(OrderListMenProducts.this, ordersList);
                                                //set to recyclerview
