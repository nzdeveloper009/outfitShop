...
public class OrderListSpecialProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_list_special_products);
        Intent i = getIntent();
        if (i != null) {
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Credentials").child("SELLER").child(uid).child("Orders").child("Special Products");
                                    ...
                                    .addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            if (snapshot.exists()) {
                                                ...
                                                //setup adapter
                                                adapterOrderBuyer = new AdapterOrderBuyer(OrderListSpecialProducts.this, ordersList);
                                                //set to recyclerview
