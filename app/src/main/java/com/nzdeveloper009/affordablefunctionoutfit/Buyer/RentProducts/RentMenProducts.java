...
public class RentMenProducts extends AppCompatActivity {

    private RecyclerView shopsRv;
    private ArrayList<ModelShop> shopList;
    private AdapterMenShop adapterMenShop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent_men_products);
        ...
        reference.child("SELLER").orderByChild("userType").equalTo("SELLER")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterMenShop = new AdapterMenShop(RentMenProducts.this,shopList);
                        //set adapter to recyclerview
                        shopsRv.setAdapter(adapterMenShop);
                    }
