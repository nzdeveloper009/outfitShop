...
public class BuyerMenShopDetails extends AppCompatActivity {
    ...
    private AdapterMenProducts adapterMenProducts;

    String sellerUsername,sellerEmail,sellerPhone,sellerProductColor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_men_shop_details);
        ...
        if(i != null)
        {
            ...
            sellerProductColor = i.getStringExtra("pColor");
        ...
        reference.child(sellerUsername).child("Men Products")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterMenProducts = new AdapterMenProducts(BuyerMenShopDetails.this,productList);
                        //set adapter
                        productsRv.setAdapter(adapterMenProducts);
                    }
