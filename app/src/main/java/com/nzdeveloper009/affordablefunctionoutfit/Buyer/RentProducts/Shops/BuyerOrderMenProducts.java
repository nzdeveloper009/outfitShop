...
public class BuyerOrderMenProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_order_men_products);
    ...
    private void submitOrder() {
        ...
        ref.child("Men Products").child(timestamp).setValue(hashMap)
