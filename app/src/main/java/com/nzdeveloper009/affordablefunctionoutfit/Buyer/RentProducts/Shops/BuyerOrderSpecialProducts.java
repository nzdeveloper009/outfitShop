...
public class BuyerOrderSpecialProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_order_special_products);
    ...
    private void submitOrder() {
        ...
        ref.child("Special Products").child(timestamp).setValue(hashMap)
    ...
    private boolean validation() {
        ...
        if(!username.isEmpty())
        {
            ...
            reference.child("BUYER").child(username)
