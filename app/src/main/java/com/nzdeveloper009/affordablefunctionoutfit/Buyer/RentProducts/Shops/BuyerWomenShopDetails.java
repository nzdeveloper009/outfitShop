...
import com.nzdeveloper009.affordablefunctionoutfit.AdapterClasses.AdapterWomenProducts;
...
public class BuyerWomenShopDetails extends AppCompatActivity {
    //declare ui views
    ...
    private AdapterWomenProducts adapterWomenProducts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_women_shop_details);
        ...
        reference.child(sellerUsername).child("Men Products")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterWomenProducts = new AdapterWomenProducts(BuyerWomenShopDetails.this,productList);
                        //set adapter
                        productsRv.setAdapter(adapterWomenProducts);
                    }
    ...
    private void loadShopProducts() {
        reference = FirebaseDatabase.getInstance().getReference("Products");
        productList = new ArrayList<>();
        reference.child(sellerUsername).child("Women Products")
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        //before getting reset list
