...
import com.nzdeveloper009.affordablefunctionoutfit.Seller.AddProducts.ProductDetails.GetMenProductDetail;
import com.sdsmdg.tastytoast.TastyToast;

import java.util.ArrayList;

public class AddMenProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_men_products);
        ...
        if(intent!=null)
        {
            ...
            addProducts.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getApplicationContext(), GetMenProductDetail.class);
        ...
        reference.child(sellerUsername).child("Men Products")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        //setup adapter
                        adapterProductSeller = new AdapterProductSeller(AddMenProducts.this,productList);
                        //set adapter
