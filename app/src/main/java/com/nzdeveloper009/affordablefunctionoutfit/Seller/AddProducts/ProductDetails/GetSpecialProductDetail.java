...
public class GetSpecialProductDetail extends AppCompatActivity {
    ...
    String productCategory = "Special Products";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_special_product_detail);
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        task.getResult().getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                newUri = uri.toString();
                                Picasso.with(GetSpecialProductDetail.this)
                                        .load(newUri)
                                        .into(imageView);
                            }
                        });
    ...
    private void addProduct() {
        ...
        reference.child(username).child(productCategory).child(timestamp).setValue(data)
            ...
            public void onSuccess(Void aVoid) {
                ...
                TastyToast.makeText(getApplicationContext(),"Successfully added Product",TastyToast.LENGTH_SHORT,TastyToast.SUCCESS).show();
            }
        })
            ...
            public void onFailure(@NonNull Exception e) {
                // failed adding to db
                progressDialog.dismiss();
                TastyToast.makeText(getApplicationContext(),"Not Posted Successfully",TastyToast.LENGTH_SHORT,TastyToast.ERROR).show();
            }
        });
    }
