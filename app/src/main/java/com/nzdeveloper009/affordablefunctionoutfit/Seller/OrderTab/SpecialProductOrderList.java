...
public class SpecialProductOrderList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_product_order_list);
        ...
        filterOrderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //dialog
                //dialog
                AlertDialog.Builder builder = new AlertDialog.Builder(SpecialProductOrderList.this);
    ...
    private void loadAllOrders() {
        ...
        reference.child("SELLER").child(sellerUsername).child("Orders").child("Special Products")
